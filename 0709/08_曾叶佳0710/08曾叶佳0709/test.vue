...
<!--
        ...
        <Child v-for="item in itemList" :key="item.data" class="child">
            <template>
                <input name='xuanz'  :type="type" :value="item.week" @click="goDetail">
      ...
      <button @click="goDetail">确认</button>
